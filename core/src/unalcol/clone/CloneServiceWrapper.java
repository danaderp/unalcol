 ...
 * @version 1.0
 */
public class CloneServiceWrapper extends ServiceWrapper implements CloneService {
    /**
     * Creates a clone wrapped method for objects
     */
    public CloneServiceWrapper(){        
        super("clone");
    }
    ...
    public static void main( String[] args ){
        CloneServiceWrapper w = new CloneServiceWrapper();
        w.clone(1.0);
    }
}