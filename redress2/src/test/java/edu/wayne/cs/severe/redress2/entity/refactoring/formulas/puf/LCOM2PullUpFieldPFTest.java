...
public class LCOM2PullUpFieldPFTest {
	...
	public void testPredictMetrVal() throws Exception {
		LCOM2PullUpFieldPF form = new LCOM2PullUpFieldPF();
		...
		expVals = new double[] { expec2, expec2, expec2, 1.0 };
		...
		numFields = 1;
		numFieldUsage = 1;
		expec2 = 1 - (numFieldUsage / (numFields * numMethods));
